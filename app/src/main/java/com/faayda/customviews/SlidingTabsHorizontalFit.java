...
/**
 * Created by Aashutosh @ vinove on 8/7/2015.
 */
public class SlidingTabsHorizontalFit extends LinearLayout {
    ...
    public SlidingTabsHorizontalFit(Context context) {
        this(context, null);
    }

    public SlidingTabsHorizontalFit(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingTabsHorizontalFit(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setTextColorForTabs(int color) {
    ...
    protected TextView createDefaultTabView(Context context) {
        ...
        //if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) textView.setAllCaps(true);
